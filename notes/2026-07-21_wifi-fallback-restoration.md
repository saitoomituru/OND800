...
操作者がOBSから両NDI sourceを明示的に再取得した後、送信側logは06:19:52〜06:20:25に次を示した。

- C922: frames 18,300→19,200、drops 0、connections 1
- C960: frames 18,300→19,200、drops 0、connections 1

同じsource名、同じsender processでも、有線`192.168.0.13`からWi-Fi`192.168.0.14`へtransport endpointが変わった時は自動復帰せず、OBS側receiverの明示再取得で復帰した。
